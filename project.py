...
def main():
    ...
    age, days = calculate(birthmonth, int(birthday), int(birthyear), date.today())
...
def calculate(birthmonth: str, birthday: int, birthyear: int, today):
    """
    ...
    return total_age, time_to_birthday.days
